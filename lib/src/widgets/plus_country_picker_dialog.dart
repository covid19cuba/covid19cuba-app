...
class PlusCountryPickerDialog extends StatefulWidget {
  ...
  @override
  PlusSingleChoiceDialogState createState() {
    return new PlusSingleChoiceDialogState();
  }
}

class PlusSingleChoiceDialogState extends State<PlusCountryPickerDialog> {
