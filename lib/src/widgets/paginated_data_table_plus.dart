...
class PaginatedDataTablePlus extends StatefulWidget {
  ...
  /// particular [PaginatedDataTablePlus] widget is created; avoid creating a new
  /// [DataTableSource] with each new instance of the [PaginatedDataTablePlus]
...
class PaginatedDataTablePlusState extends State<PaginatedDataTablePlus> {
  ...
  Widget build(BuildContext context) {
    ...
    footerWidgets.addAll(<Widget>[
      ...
      Text(
        '${_firstRowIndex + 1}-${_firstRowIndex + widget.rowsPerPage} '
        'de $_rowCount',
      ),
      Container(width: 32.0),
      IconButton(
