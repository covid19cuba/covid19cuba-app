...
class EvolutionSymptomaticsAsymptomaticsWidget extends StatelessWidget {
  final EvolutionSymptomaticsAsymptomaticsDays
      evolutionSymptomaticsAsymptomatics;

  const EvolutionSymptomaticsAsymptomaticsWidget(
      {this.evolutionSymptomaticsAsymptomatics})
      : assert(evolutionSymptomaticsAsymptomatics != null);
    ...
    return Column(
      children: <Widget>[
        Container(
          ...
          child: Center(
            child: Text(
              'Evolución de casos sintomáticos/asintomáticos',
          ...
          child: charts.TimeSeriesChart(
            [
              charts.Series<List, DateTime>(
                ...
                data: zip([
                  evolutionSymptomaticsAsymptomatics.symptomatics.values,
