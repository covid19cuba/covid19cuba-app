...
class RandomColor {
  ...
  ChartColor.Color randomChartColor(
      {ColorHue colorHue = ColorHue.random,
      ColorSaturation colorSaturation = ColorSaturation.random,
      bool debug = false}) {
    int saturation;
    ...
    ChartColor.Color _getDarkerColor(int darkerShade) {
  ...
  ChartColor.Color _getChartColor(int hue, int saturation, int brightness) {
    final double s = saturation / 100;
    final double v = brightness / 100;
